    ...
    <section id="about" className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 md:order-1">
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-purple-100 to-teal-100 aspect-[4/3] flex items-center justify-center shadow-xl">
        ...
        <div className="order-1 md:order-2">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
            We are a team of passionate builders and thinkers.
          </h2>
          ...
          <ul className="space-y-3">
            {[
              "Human-centred design at every stage",
              ...
              <li key={point} className="flex items-start gap-3 text-gray-600 text-sm">
                <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center text-xs font-bold">
                  ✓
                </span>
                {point}
              </li>
